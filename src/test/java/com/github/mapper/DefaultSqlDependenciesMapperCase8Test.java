...
import com.github.mapper.cases.DependenciesGraphCase8;
...
import static com.github.mapper.cases.DependenciesGraphCase8.expect;
 ...
 *
 */
public class DefaultSqlDependenciesMapperCase8Test {

    @Test
    void givenListMap_whenSingle_thenReturnFluxOnlyRoot() {
        RootLvl exp = expect();
        List<Map<String, Object>> tuples = DependenciesGraphCase8.tuple();
        SqlDependenciesMapper sqlDependenciesMapper =
                SqlDependenciesMapper.defaultMap(DependenciesGraphCase8.graph());
    ...
    void givenListMap_whenMany_thenReturnFluxRoot() {
        List<RootLvl> exp = DependenciesGraphCase8.expect_many();
        List<Map<String, Object>> tuples = DependenciesGraphCase8.tuples();
        SqlDependenciesMapper sqlDependenciesMapper =
                SqlDependenciesMapper.defaultMap(DependenciesGraphCase8.graph());

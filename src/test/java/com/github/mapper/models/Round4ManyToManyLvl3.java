...
public class Round4ManyToManyLvl3 {

    private Long id;

    private List<Round3ManyToManyLvl2> round3ManyToManyLvl2s = new ArrayList<>();

    public Round4ManyToManyLvl3() {
    }

    public Round4ManyToManyLvl3(Long id, List<Round3ManyToManyLvl2> round3ManyToManyLvl2s) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Round4ManyToManyLvl3)) return false;
        Round4ManyToManyLvl3 that = (Round4ManyToManyLvl3) o;
